...
IP address: 52.15.75.192.

Accessible SSH port: 2200.

Application URL: https://52.15.75.192
...
4. In your terminal, type in
	```ssh -i ~/.ssh/"key" root@52.15.75.192```
...
4. now you can use ssh to login with the new user you created
	...
	`ssh -i [privateKeyFilename] grader@52.15.75.192`
...
5. Clone the Catalog App to the virtual machine `git clone https://github.com/as17396n/catalog.git`
...
9. Edit `database_setup.py`, `catalog.py` and `login.py` and change `engine = create_engine('sqlite:///catalog.db')` to `engine = create_engine('postgresql://catalog:password@localhost/catalog')`
...
2. Add the following lines of code to the file to configure the virtual host. 
	...
	```
	<VirtualHost *:80>
		ServerName 52.15.75.192
		ServerAdmin ajinkyas420@gmail.com
